    ...
    <time datetime="2016-10-25" suppressHydrationWarning />
      ...
      <main className="bg-white px-10 md:px-20 lg:px-14 dark:bg-gray-900 ">
         <section className=" h-screen">
          ...
          <div className="relative mx-auto bg-gradient-to-b from-blue-500 rounded-full w-96 h-96 mt-36 overflow-hidden md:h-96 md:w-96">
         ...
         <section>
          <div className="">
            ...
            <p className="relative text-md py-2 leading-9 text-gray-800 text-center mx-auto dark:text-white "  >
