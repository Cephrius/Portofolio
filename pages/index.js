      ...
      <main className="bg-white px-10 md:px-20 lg:px-14 transition-all duration-700 dark:bg-gray-900 "> {/* add fade in to dark mode feature */}
         <section className=" h-screen">
          ...
          <div className="text-6xl flex justify-center gap-16 py-10 text-gray-600 dark:text-white ">
            <ToolTip textSize="lg" tooltip={"Twitter"}><a href="https://twitter.com/CEhileme" target="_blank" rel="noreferrer"><AiFillTwitterCircle className="duration-300 hover:scale-125" /></a></ToolTip>
            <ToolTip textSize="lg" tooltip={"Instagram"}><a href="https://www.instagram.com/chiedozie.py/" target="_blank" rel="noreferrer" ><AiFillInstagram className="duration-300 hover:scale-125"/> </a> </ToolTip>
            <ToolTip textSize="lg" tooltip={"Linkedin"}  ><a href="https://www.linkedin.com/in/chiedozie-ehileme-529b6a25b/" target="_blank" rel="noreferrer"><AiFillLinkedin className="duration-300 hover:scale-125" /></a></ToolTip>
            <ToolTip textSize="lg" tooltip={"GitHub"}  ><a href="https://github.com/Cephrius/" target="_blank" rel="noreferrer"><AiFillGithub className="duration-300 hover:scale-125" /></a></ToolTip>
